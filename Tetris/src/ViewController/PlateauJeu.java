...
import Model.Tetris.NextTetriminoPanel;
import Model.Tetris.PlateauTetris;
import Model.Tetris.TetrisGameCore;
...
public class PlateauJeu extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        PlateauTetris plateau = new PlateauTetris(20, 10, 4, 4);
        NextTetriminoPanel nextTetriminoPanel = new NextTetriminoPanel();
        ...
        Text levelInput = new Text(String.valueOf(plateau.getLevel()));
        levelInput.setWrappingWidth(90);
        levelInput.setTextAlignment(TextAlignment.CENTER);
        levelInput.setFill(Color.BLACK);
        ...
        //GridPane2//
        //*********//
        VuePlateau vuePlateauTetris = new VuePlateau(20,10);
        vuePlateauTetris.getgPane2().setPrefWidth(300);
        vuePlateauTetris.getgPane2().setPrefHeight(520);
        //gPane2.setStyle("-fx-background-color: #008000;");
        //gPane2.setGridLinesVisible(true);
        vuePlateauTetris.getgPane2().requestFocus();
        //Sound
        ...
        vuePlateauTetris.getgPane2().getChildren().add(mediaView);
        //
        ...
        border.setCenter(vuePlateauTetris.getgPane2());
        ...
        //timeline
            Timeline timeline = new Timeline(new KeyFrame(
                        Duration.millis(100),
                        (ActionEvent ae) -> {
                            TetrisGameCore.jeu(plateau, vuePlateauTetris.getCouleursRectPlateau(), couleursRectSuivants, nextTetriminoPanel);}));
        ...
        plateau.addObserver((Observable o, Object arg) -> {
            ...
            Case tmp = (Case) arg;
            if (vuePlateauTetris.getColouredRectPlateau()[tmp.getCoord().getX()][tmp.getCoord().getY()] == false) {
                vuePlateauTetris.getRectPlateau()[tmp.getCoord().getX()][tmp.getCoord().getY()].setFill(convertColor(vuePlateauTetris.getCouleursRectPlateau()[tmp.getCoord().getX()][tmp.getCoord().getY()]));
                vuePlateauTetris.getColouredRectPlateau()[tmp.getCoord().getX()][tmp.getCoord().getY()] = true;
            } else if (vuePlateauTetris.getColouredRectPlateau()[tmp.getCoord().getX()][tmp.getCoord().getY()] == true) {
                vuePlateauTetris.getRectPlateau()[tmp.getCoord().getX()][tmp.getCoord().getY()].setFill(Color.BLACK);
                vuePlateauTetris.getColouredRectPlateau()[tmp.getCoord().getX()][tmp.getCoord().getY()] = false;
            }
           }
        ...
        nextTetriminoPanel.addObserver((Observable o, Object arg) -> {
            Case tmp = (Case) arg;
            if (colouredRectSuivant[tmp.getCoord().getX()][tmp.getCoord().getY()] == false) {
                rectSuivants[tmp.getCoord().getX()][tmp.getCoord().getY()].setFill(convertColor(couleursRectSuivants[tmp.getCoord().getX()][tmp.getCoord().getY()]));
                colouredRectSuivant[tmp.getCoord().getX()][tmp.getCoord().getY()] = true;
            } else if (colouredRectSuivant[tmp.getCoord().getX()][tmp.getCoord().getY()] == true) {
                rectSuivants[tmp.getCoord().getX()][tmp.getCoord().getY()].setFill(Color.BLACK);
                colouredRectSuivant[tmp.getCoord().getX()][tmp.getCoord().getY()] = false;
            }
        });
        scene.setOnKeyPressed((KeyEvent e) -> {
            if (e.getCode() == KeyCode.LEFT) {
                
                TetrisGameCore.moveLeft(plateau, vuePlateauTetris.getCouleursRectPlateau());
                
            }
            if (e.getCode() == KeyCode.RIGHT) {
                
                TetrisGameCore.moveRight(plateau, vuePlateauTetris.getCouleursRectPlateau());
            }
            if (e.getCode() == KeyCode.UP) {
                
                TetrisGameCore.rotate(plateau, vuePlateauTetris.getCouleursRectPlateau());
               
            }
            if (e.getCode() == KeyCode.DOWN) {
                
                TetrisGameCore.moveDown(plateau, vuePlateauTetris.getCouleursRectPlateau());
