...
public class TetriminoT extends Tetrimino{
    ...
    private static final boolean[][] TABTETRIMINO =new boolean[][]{{false,true,false,false,true,true,true,false,false,false,false,false,false,false,false,false},
    ...
    public static final Couleur color = Couleur.PURPLE;
    public TetriminoT() {
        super(3,"TetriminoT",0,TABTETRIMINO,4,4,color);
    }
}
