...
public class TetriminoS extends Tetrimino {
    ...
    private static final boolean[][] TABTETRIMINO=new boolean[][]{{false, true, true, false, true, true, false, false, false, false, false, false, false, false, false, false}, 
    ...
    public static final Couleur color = Couleur.GREEN;
    public TetriminoS() {
        super(7,"TetriminoS",0,TABTETRIMINO,4,4,color); 
    }
}
